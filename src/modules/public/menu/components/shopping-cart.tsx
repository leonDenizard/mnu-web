...
export function ShoppingCart({ items, onChangeQuantity, onRemove, onCheckout }: { items: CartItem[]; onChangeQuantity: (id: string, quantity: number) => void; onRemove: (id: string) => void; onCheckout: () => void }) {
